...
{% include figure.liquid path="assets/img/Queue.png" class="img-fluid rounded z-depth-1" %}
</div>
</div>
...
<div class="row mt-3">
<div class="col-sm mt-3 mt-md-0">
{% include figure.liquid path="assets/img/Queue_operation.png" class="img-fluid rounded z-depth-1" %}
</div>
</div>
