...
> Let $$f$$ and $$g$$ be functions from the set of integers or the set of real numbers to the set of real numbers We say that $$f(x)$$ is $$O(g(x))$$ if there exist positive constants $$C$$ and $$k$$ such that: <br>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; $$|f(x)| \leq  C|g(x)|$$ <br>
...
{% include figure.liquid path="assets/img/Big_O_graph.png" class="img-fluid rounded z-depth-1" %}
</div>
</div>
...
<div class="row mt-3">
<div class="col-sm mt-3 mt-md-0">
{% include figure.liquid path="assets/img/Big_O_chart.png" class="img-fluid rounded z-depth-1" %}
</div>
</div>
