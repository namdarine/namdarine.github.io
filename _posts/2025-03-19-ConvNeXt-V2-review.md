...
- **Masking**: Generate a random mask ***M*** with 60% mask rate for input image ***I***. ***M*** is defined in units of $ 32 \times 32 $ patches at the last stage and is tailored to the original resolution by upsampling.  
